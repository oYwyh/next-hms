...
import { addSchema, TaddSchema, TeditSchema } from "@/app/(dashboard)/types";
import { TbaseSchema, THours } from "@/lib/types";
import {
  Dialog,
  DialogContent,
  DialogTitle,
...
import { add } from "@/app/(dashboard)/_actions/operations.actions";
