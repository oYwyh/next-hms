...
export function Diagnosis({ appointmentId, view, reservation }: { appointmentId: string | number, view: boolean, reservation?: any }) {
    ...
    const onSubmit = async (data: TdiagnosisSchema) => {
        ...
        if (result && result.reserved) {
            ...
            if (selectedMedicine.length > 0) {
                return router.push(`/doctor/appointments/reservation/${appointmentId}/prescriptions/medicines`)
            }
