...
export default function Files({ folderId, userId }: { folderId: number, userId: string }) {
            ...
            {isLoading ? <p>Loading...</p> : (
                <div className='p-4'>
                    <div className="flex flex-row justify-between">
                        ...
                        <FileUploader folderId={folderId} open={open} setOpen={setOpen} userId={userId} />
                                            ...
                                            return (
                                                <div className="flex flex-row gap-5">
                                                    <Trash2 className="cursor-pointer" color='red' onClick={async () => {
                                                        await deleteFile(activeFile.name, true, true)
